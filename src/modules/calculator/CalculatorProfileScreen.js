      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.container}>
        ...
        <View style={styles.body}>
          <Formik
            ...
            onSubmit={(form) => {
              handleProfileCalculate({...form, values: shape.values});
            }}
            enableReinitialize>
            {({values, handleSubmit, handleChange, setFieldValue, resetForm}) => (
              <>
                ...
                <View style={styles.box}>
                  <View style={styles.inputTitleBox}>
                    <Text style={styles.inputTitle}>Aba</Text>
                  </View>
                ...
                <View style={styles.box}>
                  <View style={styles.inputTitleBox}>
                    <Text style={styles.inputTitle}>Alma</Text>
                  </View>
                  <View style={styles.inputBox}>
                    <TextInput
                      placeholder="0"
...
export default CalculatorProfileScreen;
